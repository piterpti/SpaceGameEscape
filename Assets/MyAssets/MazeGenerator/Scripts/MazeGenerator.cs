...
{   
	...
	void Start()
	{
		...
		if (prefabWall == null || prefabExternalWall == null || prefabMeta == null)
			Debug.LogError("Nie przypisano prefabu!");
        //meta
        Vector3 temp = new Vector3(sizeX-1, sizeY - 1, 0);
        Instantiate(prefabMeta, temp, transform.rotation);
        //player
        temp = new Vector3(player_x, player_y, 0);
        Instantiate(prefabPlayer, temp, transform.rotation);
        //maze
        createMaze();
	}
